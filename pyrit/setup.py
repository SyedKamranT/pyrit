...
class LazyBuilder(build_ext):
    ...
    those flags disabled. This is not exactly elegant but probably
    the most portable solution given the limited capabilities of distutils
    to detect compiler-versions.
    '''
...
setup_args = dict(
    ...
    long_description="Pyrit allows to create massive databases, pre-computing part "
